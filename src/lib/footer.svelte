<footer class="footer footer-center p-10 bg-primary-focus text-primary-content">
  <div>
    <span class="w-14">
    ...
    <span class="text-3xl font-poppins">Stockify </span>
    <p class="font-inter font-thin">A prathamprasoon.com project</p>
  </div> 
  <!-- <div>
