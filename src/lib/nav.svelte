	...
	<div class="navbar bg-primary text-primary-content rounded-2xl shadow">
		<div class="navbar-start">
			<div class="dropdown">
				...
				<ul
					tabindex="0"
					class="mt-3 p-2 shadow menu dropdown-content bg-base-100 w-52 border-2 border-neutral"
				>
		...
		<div class="navbar-center">
			<a class="btn btn-ghost normal-case text-xl font-serif" href="/"
				><div class="w-7"><svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512"
		...
		<div class="navbar-end">
			<label class="swap swap-rotate">
				...
				<span class="btn btn-ghost btn-circle swap-on"
					><div class="w-7"><svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512"
					...
					></div></span
				>
				<div class="btn btn-ghost btn-circle swap-off"
					><div class="w-7"><svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512"
